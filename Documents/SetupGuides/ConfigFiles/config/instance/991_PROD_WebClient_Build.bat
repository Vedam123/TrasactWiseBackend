...
:: Step 8: Change directory to WebClient and echo the directory, then run npm build
cd /d "%webclient_path%"
if errorlevel 1 (
...
echo Now building the project with npm...

:: Run npm build
npm run build

:: Check if npm build was successful or not
if errorlevel 1 (
