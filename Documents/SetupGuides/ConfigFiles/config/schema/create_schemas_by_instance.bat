...
echo Python is installed. Running create_schemas_by_instance_py script...
python "%~dp0create_schemas_by_instance_py.py"

REM Check if the script executed successfully
if %ERRORLEVEL% NEQ 0 (
    echo Error: create_schemas_by_instance_py encountered an issue during execution.
    pause
    exit /b 1
)
