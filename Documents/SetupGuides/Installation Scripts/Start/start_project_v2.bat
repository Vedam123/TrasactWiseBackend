...
REM Step 28: Move to current directory where it started
cd "%GP_DIR%"
...
REM Step 29: Change directory to the instance directory
...
REM Step 30: Check if INSTALL.bat exists in the instance directory
