...
def get_user_permissions_from_database(user_id):
    ...
    print("Entered to check if user has permission",user_id)
    ...
    print("Entered to check if user has permission username ",user_id)
...
def authorize_user():
    ...
    print("Current user in authorize_user functon", current_user)
    ...
    print("existing permissions",user_permissions)
