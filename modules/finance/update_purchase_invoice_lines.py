...
# Define the route
@update_purchase_invoice_lines_api.route('/update_purchase_invoice_lines/<int:header_id>/<string:line_number>', methods=['PUT'])
@permission_required(WRITE_ACCESS_TYPE, __file__)
def update_purchase_invoice_lines(header_id, line_number):
    try:
        ...
        if record_exists:
            ...
            update_existing_record(mydb, header_id, line_number, item_id, quantity, unit_price, line_total, uom_id, current_userid)
...
def update_existing_record(mydb, header_id, line_number, item_id, quantity, unit_price, line_total, uom_id, current_userid):
    try:
        # Update query
        update_query = """
        ...
        mycursor.execute(update_query, (item_id, quantity, unit_price, line_total, uom_id, current_userid, header_id, line_number))
        mydb.commit()
