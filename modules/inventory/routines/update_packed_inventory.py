...
def update_packed_inventory(input_params, result_params, mydb, USER_ID, MODULE_NAME, created_by, updated_by):
    try:
        # Log entry point
        logger.info(f"{USER_ID} --> {MODULE_NAME}: Entered update_packed_inventory function")
        ...
        if result_params['remainder_quantity'] == 0:
            ...
            update_query = """
                ...
                SET quantity = %s, uom_id = %s, additional_info = CONCAT(additional_info, %s), updated_by = %s
            ...
            try:
                ...
                return ('Update Operation is failed'), 400
            ...
            try:
                ...
                return ('Update Operation is failed so exception raised failed') , 400 
